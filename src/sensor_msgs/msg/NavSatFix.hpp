...
public:
    ...
    eProsima_user_DllExport void position_covariance(
            const double__9& _position_covariance)
    {
     ...
     */
    eProsima_user_DllExport void position_covariance(
            double__9&& _position_covariance)
    {
     ...
     */
    eProsima_user_DllExport const double__9& position_covariance() const
    {
     ...
     */
    eProsima_user_DllExport double__9& position_covariance()
    {
        return m_position_covariance;
    }
...
private:
    ...
    double__9 m_position_covariance{0.0};
